...
export const AngleRightLight = (props) => {
  return (
    <AngleRightLightStyled {...props}>
      <svg height="30" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512">
    ...
    </AngleRightLightStyled>
  )
}

const AngleRightLightStyled = styled.i`
